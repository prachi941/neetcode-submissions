...
public:
    ...
    //helper function for finding total hours for a particular speed
    ...
    int minEatingSpeed(vector<int>& piles, int h) {
        ...
        //finding the last ele for search space, i.e. max eating speed
        int max = piles[0];
        ...
        int ans = end;// will store min eating speed
